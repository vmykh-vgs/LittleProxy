...
public class TraceUtils {
  ...
  public static final String HEADER_VGS_CUSTOMER_B3_SAMPLED = "VGS-Customer-B3-Sampled";
  public static final String HEADER_VGS_CUSTOMER_B3_PARENTSPANID = "VGS-Customer-B3-ParentSpanId";
